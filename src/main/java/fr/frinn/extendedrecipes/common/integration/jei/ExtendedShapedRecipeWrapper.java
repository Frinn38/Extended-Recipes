...
public class ExtendedShapedRecipeWrapper implements ICraftingCategoryExtension {

    private ShapedRecipeExtended recipe;

    public ExtendedShapedRecipeWrapper(ShapedRecipeExtended recipe) {
        this.recipe = recipe;
    }
    ...
    public void drawInfo(int recipeWidth, int recipeHeight, double mouseX, double mouseY) {
        ...
        if(recipe != null && player != null && player.world != null) {
            ...
            if(flag) {
                ...
                IDrawableBuilder builder = new DrawableBuilder(new ResourceLocation("extendedrecipes:textures/check.png"), 0, 0, 16, 16);
